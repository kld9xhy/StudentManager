package com.cornk.studentmanager;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main);        //khoi tao doi tuong DBHelper
        db = new DBHelper(MainActivity.this);        //mapping listview
        listView = (ListView)findViewById(R.id.list);        //load danh sach sinh vien
        arrayList = db.getAllStudent();
        studentAdapter = new StudentAdapter(MainActivity.this,
                R.layout.layout_row,
                arrayList);
        listView.setAdapter(studentAdapter);         //dang ky menu COntext cho listView
